...
<c:forEach var="index" begin="0" end="5">
    <li>
        ...
        <form action="goDetails.do" method="post">
            ...
            <!-- 첫 번째 이미지만 출력 -->
            <c:if test="${not empty RatingUrl[index] and not empty RatingUrl[index][0]}">
...
<!-- 
			...
			<section id="region">
				...
				<div class="region-imgs">
					<div class="big-img">
						<img src="https://life-style-f-hotel.seoulhotelskorea.com/data/Photos/700x500w/677/67716/67716833.JPEG" alt="큰썸네일">
