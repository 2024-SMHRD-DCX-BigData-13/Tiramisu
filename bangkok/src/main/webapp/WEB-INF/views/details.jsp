        ...
        <main>
            <div class="wrap">
                <section id="detail-top">
                    <div class="big-intro">
                        <img src="https://placehold.co/520x360" alt="big-img">
                        <div class="big-text">
                            <h2>eget vitae dui</h2>
                            <p>
                                주소 : 전라남도 목포시 산정로212번길<br>
                                전화번호 : 000-000-0000<br>
                                체크인 시간 : 00시 00분/00시 00분<br>
                                테마 :
                            </p>
                            <h3>인허가 정보</h3>
                            <div class="detail-box">
                                <p>
                                    인허가 등록 일자 : <p id="start"><br>
                                    인허가 만료 일자 : <p id="end">
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="small-intro">
                        ...
                        <ul class="small-intro-slider">
                            <li><img src="https://placehold.co/240x160" alt="img"></li>
                            <li><img src="https://placehold.co/240x160" alt="img"></li>
                            <li><img src="https://placehold.co/240x160" alt="img"></li>
                            <li><img src="https://placehold.co/240x160" alt="img"></li>
                            <li><img src="https://placehold.co/240x160" alt="img"></li>
